...
<head>
    ...
    <?php
        if(isset($_GET['item_id'])){
            ...
            $my_product = " SELECT * FROM product WHERE id=$item_id";
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST' ) {
            ...
            $insertSql = "UPDATE  product  set name = '$name', discretion='$discretion', status_id='$status_id', price='$price', main_category_id='$category_main_id', brand='$brand', latitude='$latitude', longitude='$longitude', age_id='$age_id',operator_code='$operator_code',phone='$phone', date_of_upload='$date_of_upload', city='$city', street='$street', building_number='$building_number'"
                ."WHERE id ='$item_id' ";
    ...
    <form  id="add-item-form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
        ...
        <div class="details-wrapper">
            ...
            <div class="customer-details">
                ...
                <div class="customer-details-id" id="customer-details-id1">
                ...
                <div class="phone">
                    ...
                    <div class="phone_number">
                        ...
                        -
                        <input type="tel" id="phone" name="phone" placeholder ="טלפון" required  value="<?php echo $item['phone']?>" pattern=".{7,7}" ><br>
                    </div>
                </div>
                <div class="address">
                    <div class="city">
                        <label for="city" class="required">עיר </label><br>
                        <input type="text" id="city" name="city" placeholder ="עיר" required  value="<?php echo $item['city']?>"><br>
                    </div>
                    <div class="street">
                        <label for="street">רחוב </label><br>
                        <input type="text" id="street" name="street" placeholder="רחוב"  value="<?php echo $item['street']?>"><br>
                    </div>
                    <div class="house-number">
                        <label for="house-number">דירה </label><br>
                        <input type="number" id="house-number" name="house-number"   value="<?php echo $item['building_number']?>">
                        <br>
                    </div>
            ...
            <div class="item-details">
                ...
                <div class="item-details-name">
                    ...
                    <input type="text" id="item-name"  name="item-name" placeholder="שם המוצר" value="<?php echo $item['name']?>" required><br>
                </div>
                <div class="item-details-description">
                    <label for="description">תיאור המוצר</label><br>
                    <input type="text" id="description" name="description" placeholder="עד 36 תווים"  value="<?php echo $item['discretion']?>"><br>
                </div>
                ...
                <div class="item-details-img">
                    ...
                    <div class="img-upload-wrapper">
                        <input type="file"  name="item-details-img_file" id="item-details-img_file"  onchange="loadFile(event)"   dir="rtl" required/>
                        <img id="output" />
                    </div>
                    <script>
                ...
                <div class="item-details-brand">
                    ...
                    <input type="text" id="item-brand" name="item-brand" placeholder="מותג"value="<?php echo $item['brand']?>"><br>
                </div>
            ...
            <div class="input-div">
                ...
                <div class="sumbit-img-bottom">
                    <button onclick="geocode()">לחץ כאן לסיום</button>
...
<script>
  document.getElementById("customer-details-id1").style.display = "none";
  function geocode(){
